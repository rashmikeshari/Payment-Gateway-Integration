...
<body>
    ...
    <div class="container0">
    	    ...
    	    <div class="form">
                ...
                <div class=form_1>
                    <p class="info" style="font-size: 1.5em; font-weight: bold; padding:3em;">
    	...
    	<a class="donate" href="https://rzp.io/l/yprcxsuNKq" style="font-size:1.8em; text-decoration: none; font-weight: bolder; background-color: black; color: white; border: 3px solid black; padding:10px;" onmouseover="details(this)" onmouseout="back(this)">DONATE NOW</a>
    ...
    <footer><i class="fa fa-copyright"></i>2021. Made by Rashmi</footer>
